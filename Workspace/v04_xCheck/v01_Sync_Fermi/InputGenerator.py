...
for massBinEdgePair in list_massBinEdgePair:
    ...
    # -- mandatory options
    # -- need to synchronize fermi constant by hand
    generator.tag = "ForXCheck_SyncFermi_M%.0lfto%.0lf" % (lowerEdge, upperEdge)
    generator.nCore = 12

    generator.FEWZPath = "/home/kplee/Physics/FEWZ/LHAPDF_621/FEWZ_3.1.rc" # -- absolute path!
    generator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v04_xCheck/v01_Sync_Fermi" # -- absolute path!
...
scriptGenerator.tag = "ForXCheck_SyncFermi"
scriptGenerator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v04_xCheck/v01_Sync_Fermi" # -- absolute path!
