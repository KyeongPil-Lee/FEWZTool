...
for massBinEdgePair in list_massBinEdgePair:
    ...
    for diRapBinEdgePair in list_diRapBinEdgePair:
        ...
        # -- mandatory options
        generator.tag = "DYReweight_BelowZPeak_largerNCall_M%.0lfto%.0lf_diRap%.1lfto%.1lf" % (minM, maxM, minY, maxY)
        ...
        generator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v12_BelowZPeak_MergeBelow20GeV/v02_largerNCall" # -- absolute path!
...
scriptGenerator.tag = "DYReweight_BelowZPeak_largerNCall"
scriptGenerator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v12_BelowZPeak_MergeBelow20GeV/v02_largerNCall" # -- absolute path!
