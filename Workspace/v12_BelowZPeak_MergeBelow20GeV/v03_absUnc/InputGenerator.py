...
for massBinEdgePair in list_massBinEdgePair:
    ...
    for diRapBinEdgePair in list_diRapBinEdgePair:
        ...
        # -- mandatory options
        generator.tag = "DYReweight_BelowZPeak_absUnc_M%.0lfto%.0lf_diRap%.1lfto%.1lf" % (minM, maxM, minY, maxY)
        generator.tag = generator.tag.replace(".", "p") # -- remove . in the file name: it makes error!!!

        # -- 8, 12, 24 ...
        generator.nCore = 48
        # generator.nCall = 10000000 # 1M -> 10M

        generator.FEWZPath = "/home/kplee/Physics/FEWZ/v03_absRapCut/FEWZ_3.1.rc" # -- absolute path!
        generator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v12_BelowZPeak_MergeBelow20GeV/v03_absUnc" # -- absolute path!

        generator.muR = scale
        generator.muF = scale

        # generator.relUnc = 0.1 # -- or generator.absUnc = XXX (absolute uncertainty is preferred)
        generator.absUnc = 623.544 * 0.001
...
scriptGenerator.tag = "DYReweight_BelowZPeak_absUnc"
scriptGenerator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v12_BelowZPeak_MergeBelow20GeV/v03_absUnc" # -- absolute path!
