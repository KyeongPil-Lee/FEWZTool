...
for massBinEdgePair in list_massBinEdgePair:
    ...
    for minZPt in list_minZPt:
        ...
        # -- mandatory options
        generator.tag = "LowMassTestZPtScan_M%.1lfto%.1lf_minZPt%.1lf" % (minM, maxM, minZPt)
        ...
        generator.WSPath = "/data9/Users/kplee/FEWZTool/v02_LowMass/Workspace/v05_ZPtScan" # -- absolute path!
...
scriptGenerator.tag = "LowMassTestZPtScan"
scriptGenerator.WSPath = "/data9/Users/kplee/FEWZTool/v02_LowMass/Workspace/v05_ZPtScan" # -- tamsa2
