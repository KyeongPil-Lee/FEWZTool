...
for massBinEdgePair in list_massBinEdgePair:
    ...
    for i in range( 0, len(list_diRapBinEdge)-1 ):
        ...
        # -- mandatory options
        generator.tag = "TestForBinOpti_v2_M%.0lfto%.0lf_diRap%.1lfto%.1lf" % (minM, maxM, minY, maxY)
        ...
        generator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v02_TestForBinOpti_NLO_v2" # -- absolute path!
        ...
        generator.list_binTextFile = ["bin_dileptonPt_v2.txt", "bin_dileptonRapidity_v2.txt"] # -- should be in WSPath
...
scriptGenerator.tag = "TestForBinOpti_v2"
scriptGenerator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v02_TestForBinOpti_NLO_v2" # -- absolute path!
