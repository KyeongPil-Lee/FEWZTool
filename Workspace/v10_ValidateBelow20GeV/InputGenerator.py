...
for massBinEdgePair in list_massBinEdgePair:
    ...
    for diRapBinEdgePair in list_diRapBinEdgePair:
        ...
        if maxY == 1.5:
            if minM == 72 and maxM == 106:  maxY = 1.2
            if minM == 200 and maxM == 400: maxY = 0.9


        generator = FEWZInputGenerator()
        # -- mandatory options
        generator.tag = "DYReweight_ValidateBelow20GeV_M%.0lfto%.0lf_diRap%.1lfto%.1lf" % (minM, maxM, minY, maxY)
        ...
        generator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v10_ValidateBelow20GeV" # -- absolute path!
...
scriptGenerator.tag = "DYReweight_ValidateBelow20GeV"
scriptGenerator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v10_ValidateBelow20GeV" # -- absolute path!
