...
for massBinEdgePair in list_massBinEdgePair:
    ...
    for diRapBinEdgePair in list_diRapBinEdgePair:
        ...
        # -- mandatory options
        generator.tag = "DYReweight_HighMass_M%.0lfto%.0lf_diRap%.1lfto%.1lf" % (minM, maxM, minY, maxY)
        ...
        generator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v18_3rdTrial_HighMass" # -- absolute path!
        ...
        generator.list_binTextFile = ["binDiPt_HighMass_v3.txt", "binDiRap_HighMass_v3.txt"] # -- should be in WSPath
...
scriptGenerator.tag = "DYReweight_HighMass"
scriptGenerator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v18_3rdTrial_HighMass" # -- absolute path!
