...
for massBinEdgePair in list_massBinEdgePair:
    ...
    for diRapBinEdgePair in list_diRapBinEdgePair:
        ...
        # -- mandatory options
        generator.tag = "DYReweight_ZPeak_M%.0lfto%.0lf_diRap%.1lfto%.1lf" % (minM, maxM, minY, maxY)
        ...
        generator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v20_postFSR_ZPeak" # -- absolute path!
        ...
        generator.EWControl = 0 # -- turn-on all effects (ISR, FSR) -> post FSR
        ...
        generator.list_binTextFile = ["binDiPt_ZPeak_v3.txt", "binDiRap_ZPeak_v3.txt"] # -- should be in WSPath
...
scriptGenerator.tag = "DYReweight_ZPeak"
scriptGenerator.WSPath = "/data9/Users/kplee/FEWZTool/v01_Reweighting/Workspace/v20_postFSR_ZPeak" # -- absolute path!
