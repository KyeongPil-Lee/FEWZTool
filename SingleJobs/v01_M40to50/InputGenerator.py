...
for massBinEdgePair in list_massBinEdgePair:
    ...
    # -- 8, 12, 24 ...
    generator.nCore = nCPUCore

    generator.FEWZPath = "/home/kplee/Physics/FEWZ/LHAPDF_621/FEWZ_3.1.rc" # -- absolute path!
    generator.WSPath = os.getcwd() # -- absolute path!
    # generator.WSPath = "/home/kplee/FEWZTool/v01_Reweighting/SingleJobs/v01_M40to50" # -- absolute path!
